...
def sign_in_proses():
    if request.method == "POST":
        ...
        elif user_name == 'driver':
            return render_template("driver.html")
        elif user_name == 'travel':
...
def family():
	...
	idrows = Item.query.filter_by(category='Indonesian')
	ffrows = Item.query.filter_by(category='Fast Food')
	return render_template("family.html", bbrows=bbrows,idrows=idrows,ffrows=ffrows)
...
def travel():
	idrows = Item.query.filter_by(category='Indonesian')
	return render_template('travel.html',idrows=idrows)
